# coding=utf-8
# This code is a modification of transformers/models/mistral/modeling_mistral.py , which is has the following copyright:
...
from .configuration_mistral_aqlm import MistralConfig
...
class MistralAttention(nn.Module):
    ...
    def __init__(self, config: MistralConfig, layer_idx: Optional[int] = None):
        ...
        self.q_proj = FinalizedQuantizedLinear(
            self.hidden_size, self.num_heads * self.head_dim, bias=False, **config.aqlm
        )
        ...
        self.o_proj = FinalizedQuantizedLinear(
            self.num_heads * self.head_dim, self.hidden_size, bias=False, **config.aqlm
        )
